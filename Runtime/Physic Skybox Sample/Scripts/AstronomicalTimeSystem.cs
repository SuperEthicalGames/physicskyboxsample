...
public sealed class AstronomicalTimeSystem : MonoBehaviour
{
    ...
    [Range(-14, 14)]
    [SerializeField]
    private double _ManualUTCOffsetHours = -5.0;
    ...
    [Tooltip(
        "Apply atmospheric refraction to apparent Sun/Moon altitude."
    )]
    [SerializeField]
    private bool _UseAtmosphericRefraction = true;

    [Tooltip(
        "Apply topocentric correction to the Moon."
    )]
    [SerializeField]
    private bool _UseLunarTopocentricCorrection = true;
    ...
    [SerializeField]
    private bool _UpdateShaderGlobals = true;
    ...
    public double ManualUTCOffsetHours =>
        _ManualUTCOffsetHours;
    ...
    /// </summary>
    public double SunGeometricAltitude =>
        _SunGeometricAltitude;


    /// <summary>
    /// Sun right ascension in degrees.
    /// </summary>
    public double SunRightAscension =>
        _SunRightAscension;
    ...
    /// </summary>
    public double MoonGeometricAltitude =>
        _MoonGeometricAltitude;


    /// <summary>
    /// Moon distance in Earth radii.
    /// </summary>
    public double MoonDistanceEarthRadii =>
        _MoonDistanceEarthRadii;
    ...
    private DateTime CreateManualDateTime(
        DateTimeKind kind
    )
    {
        int year =
    ...
    private void CalculateAstronomy()
    {
        ...
        EquatorialCoordinates moon =
            CalculateMoonEquatorial(
                _JulianDate
            );

        _MoonDistanceEarthRadii =
            moon.DistanceEarthRadii;
        ...
        {
            moonHorizontal =
                EquatorialToTopocentricHorizontal(
                    moon,
                    _Latitude,
                    _LocalSiderealTime
                );
    ...
    private EquatorialCoordinates CalculateSunEquatorial(
        double jd
    )
    {
        double T =
    ...
    private EquatorialCoordinates CalculateMoonEquatorial(
        double jd
    )
    {
        double d =
    ...
    private double ApplyRefraction(
        double altitude
    )
    {
        /*
    ...
    private Vector3 HorizontalToUnity(
        double altitude,
        double azimuth
    )
    {
    ...
    private void SendShaderGlobals(
        Vector3 sunDirection,
        Vector3 moonDirection
    )
    {
    ...
    private static double NormalizeHours(
        double value
    )
    {
        value %= 24.0;
